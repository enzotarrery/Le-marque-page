 ...
 */
final class Version20210313180350 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD image_id INT DEFAULT NULL, DROP image');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD image VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP image_id');
    }
}
